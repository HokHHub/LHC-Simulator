...
export default function About(props) {
    ...
    return (
        <>
            <section>
                <section className={s.section__mainAbout}>
                    <Container>
                ...
                <hr className={s.about__hr} />
                <Container>
                    <div className={s.other}>
                        <div className={s.other__texts}>
                            <h2 className={s.other__title}>Симуляция</h2>
                            <p className={s.other__text}>Нажмите «Начать эксперимент», чтобы запустить симуляцию столкновения частиц. Вращайте детектор мышью и наблюдайте за треками — каждый запуск генерирует уникальное событие на основе реальных физических процессов LHC.</p>
